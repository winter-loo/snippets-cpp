...
size_t ReadRequestBody(char* buffer, size_t size, size_t nitems, void* userdata) {
...
int main() {
    ...
    curl_easy_setopt(curl_handle, CURLOPT_URL, "https://10.18.1.182:9001/api/v1/login");
    curl_easy_setopt(curl_handle, CURLOPT_VERBOSE, 1l);
    curl_easy_setopt(curl_handle, CURLOPT_POST, 1l);
    curl_easy_setopt(curl_handle, CURLOPT_CAINFO, "/etc/pki/ca-trust/source/anchors/public.crt");
